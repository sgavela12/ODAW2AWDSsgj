...
buscar.addEventListener("click", bucarPersona)
...
function bucarPersona() {
    resultadoBusqueda.innerHTML = ""
    let email = prompt("Introduce un email")
    personas.forEach((persona) => {
        if (email == persona.getEmail()) {
            resultadoBusqueda.innerHTML += persona.muestraDatos()
        }else{
            resultadoBusqueda.innerHTML="No hay ninguna persona registrada con ese correo."
        }
