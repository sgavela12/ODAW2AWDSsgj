...
public class MainController {
    ...
    @GetMapping("/producto")
    public String showProducto(@RequestParam (required = false) String action,@RequestParam (required = false) String id ,Model model) {
       

        model.addAttribute("lista", productoService.getListaProductos());
        return "productoView";
