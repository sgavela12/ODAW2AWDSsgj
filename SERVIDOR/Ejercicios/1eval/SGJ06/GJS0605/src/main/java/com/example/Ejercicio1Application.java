...
public class Ejercicio1Application {
	...
	public CommandLineRunner prueba() {
		return args -> {
			productoService.nuevoProducto(new Producto((long)4888,(long)5,"tornillo",false,TipoIva.GENERAL,(double)50));
			productoService.nuevoProducto(new Producto((long)4888,(long)3,"tuerca",true,TipoIva.GENERAL,(double)50));
			productoService.nuevoProducto(new Producto((long)6555,(long)77,"arandela",false,TipoIva.GENERAL,(double)70));
