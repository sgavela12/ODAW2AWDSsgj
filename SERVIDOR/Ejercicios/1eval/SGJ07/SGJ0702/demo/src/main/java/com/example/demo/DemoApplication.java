...
public class DemoApplication {
	...
	return args -> {
		...
		empleadoService.añadir(new Empleado(0L, "sergio", "sgavela12@gmail.com", 
		800d, true, 
		Genero.MASCULINO, departamentoService.obtenerPorNombre("Informática")));

		empleadoService.añadir(new Empleado(2L, "jorge", "jorge@gmail.com", 
		8000d, false, 
		Genero.FEMENINO, departamentoService.obtenerPorNombre("RRHH")));

		empleadoService.añadir(new Empleado(3L, "patricia", "patri@gmail.com", 
		7000d, true, 
