...
public class DemoApplication {
	...
	CommandLineRunner initData(EmpleadoService empleadoService,
		...
		ProyectoService proyectoService, EmpleadoProyectoService empleadoProyectoService) {
	return args -> {

		proyectoService.nuevoProyecto(new Proyecto(0L,"Nueva normativa UE",null));
		proyectoService.nuevoProyecto(new Proyecto(0L,"Mejora Web actual",null));
		...
		empleadoProyectoService.añadir(new EmpleadoProyecto((long)44,empleadoService.obtenerPorId(1),proyectoService.encontrarPorId((long)1),"CEO"));
		empleadoProyectoService.añadir(new EmpleadoProyecto((long)45,empleadoService.obtenerPorId(2),proyectoService.encontrarPorId((long)1),"Community Manager"));
		};
	}
}
